    ...
    <section className="photo-gallery">
      <div className="container">
        <div className="row mb-3" style={{ marginLeft: "0px" }}>
          <div
            className="col-8 col-md-8 col-xl-10 text-center"
            style={{ marginRight: "0px" }}
          >
            <h2>Category</h2>
            <p className="w-lg-50">
              Here You can find the groups of products that meet a similar
              consumer need or that can substitute for each
            </p>
          </div>
          <div
            className="col-auto col-md-8 col-xl-1 text-center align-self-center"
            style={{ marginRight: "0px" }}
          >
            <a
        ...
        <div
          className="row gx-2 gy-2 row-cols-md-2 row-cols-xl-3 photos"
